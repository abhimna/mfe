    ...
    const importMap = {
      ...
      ,
        "react-dom/client": async () => {
          let pkg = await import("__mf__virtual/__mfe_internal__host__prebuild__react_mf_2_dom_mf_1_client__prebuild__.js");
            return pkg;
        }
      ,
        "react/jsx-dev-runtime": async () => {
          let pkg = await import("__mf__virtual/__mfe_internal__host__prebuild__react_mf_1_jsx_mf_2_dev_mf_2_runtime__prebuild__.js");
            return pkg;
        }
